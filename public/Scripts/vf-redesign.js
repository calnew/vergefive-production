(function(){
  ...
  function upgradeHomepageConversion(){
    ...
    if(heroTrust)heroTrust.innerHTML="<span><i class='dot'></i>Free visibility scan first</span><span><i class='dot'></i>5-module buildout</span><span><i class='dot'></i>Apply only when ready</span>";
