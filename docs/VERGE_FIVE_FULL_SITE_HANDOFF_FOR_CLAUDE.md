...
Do not use only the small dashboard example list. The full account libraries live in:
...
The redesign must preserve and visually represent all active account categories:

- Starter Net 30 vendors
- Office supply vendors
- Industrial/building vendors
- Retail/wholesale vendors
- Fleet and fuel cards
- Technology vendors
- Credit profile/building tools
- Secured business credit cards
- Secured credit lines
- Traditional business credit cards
- Store/project cards
- Corporate/no-PG cards
- CD-secured loans
- Cash-secured credit lines
- SBA-backed funding paths
- CDFI/community lender paths
- Equipment financing
- Receivables/invoice financing
- Funding caution/advisory paths

See `docs/VERGE_FIVE_CURRENT_SITE_STRUCTURE_FOR_CLAUDE.md` for the complete account name inventory.
