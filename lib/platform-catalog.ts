...
const lessonBase: Record<string, LessonSection> = {
  ...
  "bank-rating": lesson({ key: "bank-rating", phase: "Phase 3", module: "Banking Foundation", route: "/bank-rating/", title: "Bank rating", description: "Use consistent banking activity and average-balance discipline before higher-value account applications.", videos: [{ title: "Bank rating lesson", src: "/uploads/bank-rating-lesson.webm", poster: "/posters/bankrating.png" }, { title: "Your bank rating", src: "/uploads/your-bank-rating-lesson.webm", poster: "/posters/bankrating.png" }], checklist: ["Choose a realistic average-balance target.", "Track banking activity over time.", "Save recent business statements.", "Delay applications during weak periods."] }),
  ...
  cards: lesson({ key: "cards", phase: "Phase 5", module: "Starter Vendor Credit", route: "/revolving-business-credit-cards/", title: "Revolving business credit cards", description: "Move into secured, store, fleet, traditional, or corporate card paths only when the profile supports that category.", videos: [{ title: "Revolving business credit cards", src: "/uploads/revolving-business-credit-cards-recreated.webm", poster: "/posters/criteria.png" }], accountPath: "cards", matcherSignals: ["Business bank account", "Bank rating pattern", "Domain email", "Website live", "Identity records match", "Starter history", "Card purpose clear", "Application timing clean", "Owner/personal-credit risk reviewed", "No recent denials", "Proof folder ready", "Statements available", "Category selected", "Next step documented"] }),
  funding: lesson({ key: "funding", phase: "Phase 5", module: "Starter Vendor Credit", route: "/cd-business-loans/", title: "CD-secured business loans", description: "Review secured loan and funding paths after identity, banking, statements, and purpose are documented.", videos: [{ title: "CD-secured business loans", src: "/uploads/cd-business-loans-lesson.webm", poster: "/posters/bankrating.png" }], accountPath: "funding", matcherSignals: ["Business bank account", "Bank rating reviewed", "Statements available", "Funding purpose clear", "Business plan saved", "Revenue/cash-flow proof", "Collateral/deposit option reviewed", "Identity records match", "Tax/documentation path known", "No unrealistic approval promise", "Bank relationship noted", "Application timing clean", "Use of funds written", "Proof folder ready", "Fallback path selected", "Next conversation planned"] }),
};
